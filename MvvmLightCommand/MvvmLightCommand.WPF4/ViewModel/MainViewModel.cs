...
using MvvmlightCommand.WPF4.TriggerActions;
using System.Windows;

namespace MvvmlightCommand.WPF4.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public bool CanClick
        {
            ...
            set
            {
                ...
                // WPF中有CommandManager来侦听CanExecuteChanged事件，可以不用手动调用命令的RaiseCanExecuteChanged方法
